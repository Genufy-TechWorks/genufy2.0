...
//       subtitle:
//         "We go beyond services to build long-term partnerships, offering expert guidance and dedicated career support.",
//       icon: icon1,
//     },
//     {
//       title: "Quality-Driven Approach",
//       subtitle:
//         "Every project is delivered with inflexible quality standards and proactive support.",
//       icon: icon2,
//     },
//     {
//       title: "Innovative Thinking",
//       subtitle:
//         "We apply creative, forward-looking solutions to solve complex business challenges.",
//       icon: icon3,
//     },
//     {
//       title: "On-Time Delivery",
//       subtitle:
//         "We consistently meet deadlines with efficient processes and reliable execution.",
//       icon: icon4,
//     },
//   ];
//   return (
...
//           <h2 className="lg:text-5xl text-3xl leading-[50px] font-bold lg:mb-12 mb-6">
//             Why Choose Us
//           </h2>

//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 px-6 md:px-0">
//             {chooseUs.map((item, idx) => (
//               <div
//                 key={idx}
//                 className="
//     p-2 lg:p-3 rounded-[5px] text-center shadow-[0px_0px_5px_rgba(0,0,0,0.3)] transition-all duration-300 ease-in-out 
//                  hover:scale-105 hover:shadow-[0_8px_15px_rgba(0,0,0,0.25)]
//     bg-white bg-gradient-to-b from-[#90eb61] to-[#24baac] 
//     bg-[length:100%_0%] bg-no-repeat bg-top 
//     transition-all duration-[400ms] ease-in-out 
//     hover:bg-[length:100%_100%] hover:text-white hover:shadow-[0_8px_15px_rgba(0,0,0,0.25)]
//   "
//               >
//                 <div className="flex justify-center">
//                   <img
//                     className="mb-3 w-10 lg:w-[55px] lg:h-[55px] transition-all duration-500"
//                     src={item.icon}
//                     alt={item.title}
//                   />
//                 </div>
//                 <h4 className="font-semibold text-xl lg:text-lg leading-[30px] text-green-600 mb-2.5 transition-colors duration-300 group-hover:text-white">
//                   {item.title}
//                 </h4>
//                 <p className="text-[12px] lg:text-base leading-[28px] transition-colors duration-300">
//                   {item.subtitle}
//                 </p>
//               </div>
//             ))}
        ...
        <section className="lg:mt-30 mt-10 text-center lg:mx-29">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 px-6 md:px-0">
            {chooseUs.map((item, idx) => (
              <div
                key={idx}
                className="p-2 lg:p-3 shadow-[0px_0px_5px_rgba(0,0,0,0.3)] rounded-[10px] text-center transition-all duration-500 ease-in-out 
        hover:scale-105 hover:shadow-[0_8px_15px_rgba(0,0,0,0.25)] hover:bg-gradient-to-r hover:from-[#e8fff7] hover:to-[#f9fffa]"
              >
                <div className="flex justify-center">
                  <img
                    className="mb-3 w-9 lg:w-[50px] lg:h-[55px]"
                    src={item.icon}
                    alt={item.title}
                  />
                </div>
                <h4 className="font-semibold text-sm lg:text-lg leading-[30px] text-[#5FD484] mb-2.5">
                  {item.title}
                </h4>
                <p className="text-[15px] lg:text-base leading-[28px]">{item.subtitle}</p>
              </div>
            ))}
          </div>
        </section>
